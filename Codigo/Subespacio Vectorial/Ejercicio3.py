...
# kolman pagina 288 ejercicio 09 
subconjunto_a = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11))if a0 == 0]
subconjunto_b = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11))if a0 == 2]
subconjunto_c = [(a2, a1, a0) for a2, a1, a0 in zip(range(-10, 11), range(-10, 11), range(-10, 11)) if a2 + a1 == a0] 
