...
def suma_vectores(u, v):
    ...
    if len(u) != 3 or len(v) != 3:
        raise ValueError("Los vectores deben ser tuplas de tres elementos (x, y, z).")
...
def verificar_axioma_1(u, v):
    ...
    print("Si cumple")
    print("")
    return isinstance(resultado_suma, tuple) and len(resultado_suma) == 3
...
if __name__ == "__main__":
    ...
    resultado_axioma_7 = verificar_axioma_7(c,u)
    resultado_axioma_8 = verificar_axioma_8(c,d,u)
    resultado_axioma_9 = verificar_axioma_9(c,u,v)
