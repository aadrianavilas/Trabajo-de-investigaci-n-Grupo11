def suma_vectores(u, v):
    ...
    if len(u) != 3 or len(v) != 3 or u[2] != 0 or v[2] != 0:
...
def verificar_axioma_1(u, v):
    ...
    # Imprimir axioma 01
    print("Axioma 1:")
    print("(x,y,0) ⊕ (x',y',0) = (x + x', y + y', 0)")
    print()
    
    # Definición matemática
    print("Definición:")
    print("Si u y v pertenecen a vectores en ℝ³ con tercer componente fijo en 0, entonces u ⊕ v también pertenece a ℝ³ con tercer componente fijo en 0.")
    print()
    ...
    # Imprimimos la condición y el resultado de la suma
    print("Resultado de la suma:")
    print(f"u ⊕ v = {resultado_suma} tambien pertenece a vectores de ℝ³")

   
    cumple =  isinstance(resultado_suma, tuple) and len(resultado_suma) == 3
...
def verificar_axioma_2(u, v):
 # Imprimir axioma 02
    print("Axioma 2:")
    print("(x,y,0) ⊕ (x',y',0) = (x',y',0) ⊕ (x,y,0)")
    print()
    
    # Definición matemática
    print("Definición:")
    print("Si u y v pertenecen a vectores en ℝ³ con tercer componente fijo en 0, entonces u ⊕ v  = v ⊕ u")
    print()
...
def verificar_axioma_3(u, v, w):
      # Imprimir axioma
    print("Axioma 3:")
    print("Para todo u, v y w pertenecientes a vectores en ℝ³ con tercer componente fijo en 0, se cumple:")
    print("(u ⊕ v) ⊕ w = u ⊕ (v ⊕ w)")
    print()
    
    # Definición matemática
    print("Definición:")
    print("Si u, v y w son vectores en ℝ³ con tercer componente fijo en 0, entonces el orden de los sumandos no afecta al resultado de la suma.")
    print("Es decir, (u ⊕ v) ⊕ w = u ⊕ (v ⊕ w).")
    print()
...
def verificar_axioma_4(u):
    ...
    print("con tercer componente fijo en 0, se cumple u ⊕ (0, 0, 0) = (0, 0, 0) ⊕ u = u.")
    print()
...
def verificar_axioma_5(u):
    ...
    # Definición matemática
    print("Definición:")
    print("Existe un elemento -u tal que para todo vector u en ℝ³ con tercer componente fijo en 0, se cumple u ⊕ (-u) = (0, 0, 0).")
    print()
...
def verificar_axioma_6(c,u):
    ...
    # Definición matemática
    print("Definición:")
    print("Si u es un elemento de ℝ³ con tercer componente fijo en 0 y c es un número real, entonces c ⊙ u también es un elemento de ℝ³ con tercer componente fijo en 0.")
    print()
...
def verificar_axioma_7(c,d,u):
    ...
    resultado2 = multiplicacion_escalar(c, multiplicacion_escalar(d, u))
    ...
    # Definición matemática
    print("Definición:")
    print("Para todo número real c y d, y para todo vector u en ℝ³ con tercer componente fijo en 0, se cumple que (c ⊕ d) ⊙ u = c ⊙ u ⊕ d ⊙ u.")
    print()
...
def verificar_axioma_10(u):
   # Calculamos el resultado de la operación según el axioma
    ...
    # Imprimir axioma
    print("Axioma 10:")
    print("Para toda u en ℝ³ con tercer componente fijo en 0, se cumple que 1 ⊙ u = u.")
    print()
...
if __name__ == "__main__":
    ...
    resultado_axioma_10 = verificar_axioma_10(u)
